<template>
  <div class="overlay">
    <form class="modal-wrapping" @submit.prevent="signUp">
        ...
        <input type="text" class="modal-wrapping__formcontrol login-nickname" v-model="nickname">
        <div class="modal-wrapping__name">メールアドレス</div>
        <input type="e-mail" class="modal-wrapping__formcontrol login-email" v-model="email">
